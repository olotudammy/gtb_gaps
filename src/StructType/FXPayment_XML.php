...
/**
 * This class stands for FXPayment_XML StructType
 * @subpackage Structs
 */
class FXPayment_XML extends AbstractStructBase
{
    /**
     * The xmlString
    ...
    /**
     * Constructor method for FXPayment_XML
     * @uses FXPayment_XML::setXmlString()
     ...
     * Set xmlString value
     * @param string $xmlString
     * @return \StructType\FXPayment_XML
     */
