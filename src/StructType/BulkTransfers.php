...
/**
 * This class stands for BulkTransfers StructType
 * @subpackage Structs
 */
class BulkTransfers extends AbstractStructBase
{
    /**
     * The xmlRequest
    ...
    /**
     * Constructor method for BulkTransfers
     * @uses BulkTransfers::setXmlRequest()
     ...
     * @param string $xmlRequest
     * @return \StructType\BulkTransfers
     */
