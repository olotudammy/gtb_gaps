...
/**
 * This class stands for GetNIPBankResult StructType
 * @subpackage Structs
 */
class GetNIPBankResult extends AbstractStructBase
{
    /**
     * The schema
    ...
    protected $any = null;
    /**
     * Constructor method for GetNIPBankResult
     * @uses GetNIPBankResult::setSchema()
     * @uses GetNIPBankResult::setAny()
     ...
     * @uses \DOMNode::item()
     * @param \DOMDocument|string|null $schema
     * @return \StructType\GetNIPBankResult
     */
