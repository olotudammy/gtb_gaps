...
/**
 * This class stands for TransactionRequery StructType
 * @subpackage Structs
 */
class TransactionRequery extends AbstractStructBase
{
    /**
     * The xmlstring
    ...
    /**
     * Constructor method for TransactionRequery
     * @uses TransactionRequery::setXmlstring()
     * @uses TransactionRequery::setCustomerid()
     * @uses TransactionRequery::setUsername()
     * @uses TransactionRequery::setPassword()
     ...
     * Set xmlstring value
     * @param string $xmlstring
     * @return \StructType\TransactionRequery
     */
