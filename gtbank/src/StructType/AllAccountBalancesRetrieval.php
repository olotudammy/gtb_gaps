...
/**
 * This class stands for AllAccountBalancesRetrieval StructType
 * @subpackage Structs
 */
class AllAccountBalancesRetrieval extends AbstractStructBase
{
    /**
     * The xmlString
    ...
    /**
     * Constructor method for AllAccountBalancesRetrieval
     * @uses AllAccountBalancesRetrieval::setXmlString()
     ...
     * Set xmlString value
     * @param string $xmlString
     * @return \StructType\AllAccountBalancesRetrieval
     */
