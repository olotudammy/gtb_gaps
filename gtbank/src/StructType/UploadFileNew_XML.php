...
/**
 * This class stands for UploadFileNew_XML StructType
 * @subpackage Structs
 */
class UploadFileNew_XML extends AbstractStructBase
{
    /**
     * The xmlRequest
    ...
    /**
     * Constructor method for UploadFileNew_XML
     * @uses UploadFileNew_XML::setXmlRequest()
     ...
     * @param string $xmlRequest
     * @return \StructType\UploadFileNew_XML
     */
