...
/**
 * This class stands for UploadFile_IDoc StructType
 * @subpackage Structs
 */
class UploadFile_IDoc extends AbstractStructBase
{
    /**
     * The uploadFile
    ...
    /**
     * Constructor method for UploadFile_IDoc
     * @uses UploadFile_IDoc::setUploadFile()
     * @uses UploadFile_IDoc::setFileName()
     * @uses UploadFile_IDoc::setFileType()
     * @uses UploadFile_IDoc::setCustomerid()
     ...
     * @param string $uploadFile
     * @return \StructType\UploadFile_IDoc
     */
