...
/**
 * This class stands for AccountStatement_XML StructType
 * @subpackage Structs
 */
class AccountStatement_XML extends AbstractStructBase
{
    /**
     * The xmlString
    ...
    /**
     * Constructor method for AccountStatement_XML
     * @uses AccountStatement_XML::setXmlString()
     ...
     * Set xmlString value
     * @param string $xmlString
     * @return \StructType\AccountStatement_XML
     */
