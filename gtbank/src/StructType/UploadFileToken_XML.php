...
/**
 * This class stands for UploadFileToken_XML StructType
 * @subpackage Structs
 */
class UploadFileToken_XML extends AbstractStructBase
{
    /**
     * The xmlRequest
    ...
    /**
     * Constructor method for UploadFileToken_XML
     * @uses UploadFileToken_XML::setXmlRequest()
     ...
     * @param string $xmlRequest
     * @return \StructType\UploadFileToken_XML
     */
