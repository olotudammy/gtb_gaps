...
/**
 * This class stands for UploadFile_FX_IDoc StructType
 * @subpackage Structs
 */
class UploadFile_FX_IDoc extends AbstractStructBase
{
    /**
     * The uploadFile
    ...
    /**
     * Constructor method for UploadFile_FX_IDoc
     * @uses UploadFile_FX_IDoc::setUploadFile()
     * @uses UploadFile_FX_IDoc::setFileName()
     * @uses UploadFile_FX_IDoc::setFileType()
     * @uses UploadFile_FX_IDoc::setCustomerid()
     ...
     * @param string $uploadFile
     * @return \StructType\UploadFile_FX_IDoc
     */
